...
function init() {
    ...
    const sphereGeometry = new THREE.SphereGeometry(params.sphereSize);
    ...
    orbitControls.target.add(t1.a).add(t1.b).add(t1.c).add(t2.a).add(t2.b).add(t2.c).multiplyScalar(1 / 6);
